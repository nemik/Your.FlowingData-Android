...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        mItemHeightNormal = 60;//res.getDimensionPixelSize(R.dimen.normal_height);
        mItemHeightExpanded = 60;//res.getDimensionPixelSize(R.dimen.expanded_height);
    }
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    View dragger = item.findViewById(R.layout.action_row);
                    Rect r = mTempRect;
    ...
    private void startDragging(Bitmap bm, int y) {
        ...
        int backGroundColor = mContext.getResources().getColor(R.color.background);
